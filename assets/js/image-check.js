...
import { KILLERS, SURVIVORS } from './data.js?v=62';
import { PERKS } from './perks.js?v=62';
import { ADDONS, ITEMS, OFFERINGS } from './loadout.js?v=62';
import { characterImageUrl, loadoutImageUrl, perkImageUrl } from './images.js?v=62';
