...
import { KILLERS, SURVIVORS } from './data.js?v=63';
import { PERKS } from './perks.js?v=63';
import { ADDONS, ITEMS, OFFERINGS } from './loadout.js?v=63';
import { characterImageUrl, loadoutImageUrl, perkImageUrl } from './images.js?v=63';
