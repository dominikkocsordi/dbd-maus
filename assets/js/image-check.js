...
import { KILLERS, SURVIVORS } from './data.js?v=64';
import { PERKS } from './perks.js?v=64';
import { ADDONS, ITEMS, OFFERINGS } from './loadout.js?v=64';
import { characterImageUrl, loadoutImageUrl, perkImageUrl } from './images.js?v=64';
