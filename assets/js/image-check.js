...
import { KILLERS, SURVIVORS } from './data.js?v=66';
import { PERKS } from './perks.js?v=66';
import { ADDONS, ITEMS, OFFERINGS } from './loadout.js?v=66';
import { characterImageUrl, loadoutImageUrl, perkImageUrl } from './images.js?v=66';
