...
import { KILLERS, SURVIVORS } from './data.js?v=59';
import { PERKS } from './perks.js?v=59';
import { ADDONS, ITEMS, OFFERINGS } from './loadout.js?v=59';
import { characterImageUrl, loadoutImageUrl, perkImageUrl } from './images.js?v=59';
