...
import { KILLERS, SURVIVORS } from './data.js?v=56';
import { PERKS } from './perks.js?v=56';
import { ADDONS, ITEMS, OFFERINGS } from './loadout.js?v=56';
import { characterImageUrl, loadoutImageUrl, perkImageUrl } from './images.js?v=56';
