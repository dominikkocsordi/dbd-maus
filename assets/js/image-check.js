...
import { KILLERS, SURVIVORS } from './data.js?v=65';
import { PERKS } from './perks.js?v=65';
import { ADDONS, ITEMS, OFFERINGS } from './loadout.js?v=65';
import { characterImageUrl, loadoutImageUrl, perkImageUrl } from './images.js?v=65';
