...
import { initPasskeyPanel } from './passkeys.js?v=12';
import { avatarHtml, characterCellHtml, iconHtml, mountIcons, perkIconHtml } from './images.js?v=12';
import { perkName } from './perks.js?v=12';
