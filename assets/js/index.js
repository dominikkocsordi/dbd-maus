...
import { initAuth } from './auth.js?v=67';
import { expandPanel, initCollapse } from './collapse.js?v=67';
import { loadLoadoutCatalog } from './loadout-catalog.js?v=67';
import { initPasskeyPanel } from './passkeys.js?v=67';
import {
...
} from './loadout.js?v=67';
import {
  aggregate, byCharacter, escapeHtml, fmtDate, fmtDecimal, fmtNumber, fmtPercent, killTier, parseNumber, toast,
} from './utils.js?v=67';
import { createSorter } from './table-sort.js?v=67';
import { initTrackerImport, openTrackerImport } from './tracker-import-panel.js?v=67';
...
/*
  Lights Out und 2v8 lassen nur Item bzw. Kraft zu – Add-ons und Opfergabe
  bleiben dort in der Truhe. Die Felder verschwinden und werden geleert, damit
  nichts stehen bleibt, was es in der Runde gar nicht gab.
*/
