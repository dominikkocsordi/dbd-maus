...
export const ITEMS = [
  ...
  { id: 'Item_Slasher_K42Power', name: 'Test Subject #001', role: 'killer', group: 'k42', killer: 'first' },
  { id: 'Item_Slasher_Stalker', name: 'Evil Within', role: 'killer', group: 'stalker', killer: 'shape' },
  { id: 'Item_Camper_BrokenKey', name: 'Broken Key', role: 'survivor', group: 'key' },
  { id: 'Item_Camper_Flashlight_Random', name: 'Flashlight', role: 'survivor', group: 'flashlight' },
  { id: 'Item_Camper_MedKit_Random', name: 'Camping Aid Kit', role: 'survivor', group: 'medkit' },
  { id: 'Item_Camper_Toolbox_Random', name: 'Toolbox', role: 'survivor', group: 'toolbox' },
  { id: 'Item_Slasher_K26Power', name: 'Birds of Torment', role: 'killer', group: 'k26', killer: 'artist' },
  ...
  { id: 'Item_Slasher_K27Power', name: 'Deluge of Fear', role: 'killer', group: 'k27', killer: 'onryo', file: 'iconPowers_delugeOfFear.png' },
  { id: 'Item_Slasher_DreamInducer', name: 'Dream Demon', role: 'killer', group: 'dreaminducer', killer: 'nightmare' },
  { id: 'Item_Slasher_K31Power', name: 'Eyes In The Sky', role: 'killer', group: 'k31', killer: 'skull_merchant', file: 'iconPowers_drones.png' },
  { id: 'Item_Slasher_K40Power', name: 'Fazbear\'s Fright', role: 'killer', group: 'k40', killer: 'animatronic' },
  ...
  { id: 'Item_Slasher_Hatchet', name: 'Hunting Hatchets', role: 'killer', group: 'hatchet', killer: 'huntress' },
  { id: 'Item_Slasher_GhostPower', name: 'Night Shroud', role: 'killer', group: 'ghost', killer: 'ghost_face' },
  ...
  { id: 'Item_Slasher_K39Power', name: 'One-Eyed Terror', role: 'killer', group: 'k39', killer: 'ghoul' },
  { id: 'Item_Slasher_K32Power', name: 'Quantum Instantiation', role: 'killer', group: 'k32', killer: 'singularity' },
  ...
  { id: 'Item_Slasher_GasBomb', name: 'The Afterpiece Tonic', role: 'killer', group: 'gasbomb', killer: 'clown', file: 'iconPowers_gasBomb.png' },
  { id: 'Item_Slasher_HarpoonRifle', name: 'The Redeemer', role: 'killer', group: 'harpoon', killer: 'deathslinger', file: 'iconPowers_UK.png' },
  { id: 'Item_Slasher_K41Power', name: 'Unbodied Flesh', role: 'killer', group: 'k41', killer: 'krasue' },
  ...
  { id: 'Item_Slasher_PlaguePower', name: 'Vile Purge', role: 'killer', group: 'plague', killer: 'plague' },
  ...
  { id: 'Item_K44Power', name: 'Will of the Gods', role: 'killer', group: 'k44', killer: 'judgment' },
  ...
  { id: 'Item_Camper_AlexsToolbox', name: 'Alex\'s Toolbox', role: 'survivor', group: 'toolbox', file: 'iconItems_toolboxAlexs.png' },
  ...
  { id: 'Item_Survivor_MakeshiftFogVial', name: 'Apprentice\'s Fog Vial', role: 'survivor', group: 'fogvial', file: 'T_UI_iconItems_apprenticesFogVial.png' },
  { id: 'Item_Survivor_PrototypeFogVial', name: 'Artisan\'s Fog Vial', role: 'survivor', group: 'fogvial', file: 'T_UI_iconItems_artisansFogVial.png' },
  ...
  { id: 'Item_Camper_Firecracker_Chinese', name: 'Chinese Firecracker', role: 'survivor', group: 'firecracker', file: 'iconItems_chineseFirecracker.png' },
  { id: 'Item_Camper_CommodiousToolbox', name: 'Commodious Toolbox', role: 'survivor', group: 'toolbox', file: 'iconItems_toolboxCommodious.png' },
  { id: 'Item_Camper_MedKit03', name: 'Emergency Med-kit', role: 'survivor', group: 'medkit', file: 'iconItems_rundownAidKit.png' },
  { id: 'Item_Camper_EngineerToolbox', name: 'Engineer\'s Toolbox', role: 'survivor', group: 'toolbox', file: 'iconItems_toolboxEngineers.png' },
  ...
  { id: 'Item_Camper_Medkit_Anniversary2022', name: 'Masquerade Med-Kit', role: 'survivor', group: 'medkit', file: 'iconItems_medkit_anniversary2022.png' },
  ...
  { id: 'Item_Camper_MechanicsToolbox', name: 'Mechanic\'s Toolbox', role: 'survivor', group: 'toolbox', file: 'iconItems_toolboxMechanics.png' },
  { id: 'Item_Camper_MedKit04', name: 'Ranger Med-kit', role: 'survivor', group: 'medkit', file: 'iconItems_rangersAidKit.png' },
  { id: 'Item_Camper_Key', name: 'Skeleton Key', role: 'survivor', group: 'key', file: 'iconItems_key.png' },
  { id: 'Item_Camper_Flashlight02', name: 'Sport Flashlight', role: 'survivor', group: 'flashlight', file: 'iconItems_flashlightSport.png' },
  { id: 'Item_Camper_Toolbox', name: 'Toolbox', role: 'survivor', group: 'toolbox', file: 'iconItems_toolbox.png' },
  ...
  { id: 'Item_Camper_WornoutToolbox', name: 'Worn-out Tools', role: 'survivor', group: 'toolbox', file: 'iconItems_toolboxWornOut.png' },
];
...
export const OFFERINGS = [
  ...
  { id: 'ChalkPouch', name: 'Chalk Pouch', role: 'survivor' },
  { id: 'SweetWilliamSachet', name: 'Sweet William Sachet', role: 'survivor' },
  { id: 'ArdentRavenWreath', name: 'Ardent Raven Wreath', role: 'killer', file: 'iconFavors_ardentRavenWreath.png' },
  { id: 'ArdentTanagerWreath', name: 'Ardent Tanager Wreath', role: 'killer', file: 'iconFavors_ardentTanagerWreath.png' },
  { id: 'BloodyPartyStreamers', name: 'Bloody Party Streamers', role: 'killer', file: 'iconFavors_bloodyPartyStreamers.png' },
  { id: 'CutCoin', name: 'Cut Coin', role: 'killer' },
  { id: 'DevoutRavenWreath', name: 'Devout Raven Wreath', role: 'killer', file: 'iconFavors_devoutRavenWreath.png' },
  { id: 'DevoutShrikeWreath', name: 'Devout Shrike Wreath', role: 'killer' },
  { id: 'DevoutSpottedowlWreath', name: 'Devout Spotted Owl Wreath', role: 'killer' },
  { id: 'EbonyMementoMori', name: 'Ebony Memento Mori', role: 'killer', file: 'iconFavors_momentoMoriEbony.png' },
  { id: 'Anniversary2022Offering', name: 'Frightful Flan', role: 'killer' },
  { id: 'Anniversary2019Offering', name: 'Gruesome Gateau', role: 'killer' },
  ...
  { id: 'AzarovKey', name: 'Azarov\'s Key', role: 'survivor' },
  { id: 'QuantumThemeOffering', name: 'Beef Tallow Mixture', role: 'survivor' },
  { id: 'BloodiedBlueprint', name: 'Bloodied Blueprint', role: 'survivor' },
  { id: 'BogLaurelSachet', name: 'Bog Laurel Sachet', role: 'survivor', file: 'iconFavors_bogLaurelSachet.png' },
  ...
  { id: 'FragrantBogLaurel', name: 'Fragrant Bog Laurel', role: 'survivor', file: 'iconFavors_fragrantBogLaurel.png' },
  { id: 'FragrantSweetWilliam', name: 'Fragrant Sweet William', role: 'survivor', file: 'iconFavors_fragrantSweetWilliam.png' },
  { id: 'FreshBogLaurel', name: 'Fresh Bog Laurel', role: 'survivor', file: 'iconFavors_freshBogLaurel.png' },
  { id: 'FreshSweetWilliam', name: 'Fresh Sweet William', role: 'survivor' },
  { id: 'MeteorThemeOffering', name: 'Ichorous Loam', role: 'survivor' },
  { id: 'Jigsawpiece', name: 'Jigsaw Piece', role: 'survivor' },
  { id: 'MurkyReagent', name: 'Murky Reagent', role: 'survivor', file: 'iconFavors_murkyReagent.png' },
  ...
  { id: 'ShinyCoin', name: 'Shiny Coin', role: 'survivor' },
  ...
  { id: 'TornBlueprint', name: 'Torn Blueprint', role: 'survivor' },
  { id: 'VigosBlueprint', name: 'Vigo\'s Blueprint', role: 'survivor', file: 'iconFavors_vigosBlueprint.png' },
  { id: 'VigosJarOfSaltyLips', name: 'Vigo\'s Jar of Salty Lips', role: 'survivor' },
  { id: 'VigosShroud', name: 'Vigo\'s Shroud', role: 'survivor' },
  { id: 'WhiteWard', name: 'White Ward', role: 'survivor' },
];
...
export const ADDONS = [
  ...
  { id: 'Addon_K39_09', name: 'Blood-Stained Handkerchief', role: 'killer', group: 'k39' },
  { id: 'Addon_K39_10', name: 'Mado\u2019s Glove', role: 'killer', group: 'k39' },
  { id: 'Addon_Spark_OrderClassII', name: '"Order" - Class II', role: 'killer', group: 'spark' },
  { id: 'Addon_Spark_JadeCharm', name: 'Iridescent Queen', role: 'killer', group: 'spark' },
  { id: 'Addon_ReverseBearTrap_RazorWires', name: 'Razor Wires', role: 'killer', group: 'reversebeartrap' },
  { id: 'Addon_ReverseBearTrap_ShatteredSyringe', name: 'Shattered Syringe', role: 'killer', group: 'reversebeartrap' },
  { id: 'Addon_K43_04', name: 'Orderly\'s Shoe', role: 'killer', group: 'k43' },
  { id: 'Addon_K43_20', name: 'Iridescent Boat Motor', role: 'killer', group: 'k43' },
  { id: 'Addon_K25Power_02', name: 'Lively Crickets', role: 'killer', group: 'k25' },
  { id: 'Addon_K25Power_16', name: 'Original Pain', role: 'killer', group: 'k25' },
  { id: 'Addon_K25Power_13', name: 'Larry\u2019s Remains', role: 'killer', group: 'k25' },
  { id: 'Addon_K25Power_19', name: 'Engineer\u2019s Fang', role: 'killer', group: 'k25' },
  { id: 'Addon_K30_09', name: 'Call To Arms', role: 'killer', group: 'k30' },
  { id: 'Addon_K30_16', name: 'Flint and Steel', role: 'killer', group: 'k30' },
  { id: 'ADDON_trap_BloodyCoil', name: 'Bloody Coil', role: 'killer', group: 'beartrap' },
  { id: 'Addon_Beartrap_003', name: 'Trapper Bag', role: 'killer', group: 'beartrap' },
  { id: 'Addon_K42_18', name: 'Electroshock Collar', role: 'killer', group: 'k42' },
  { id: 'Addon_K42_04', name: 'Stained Glass Mural', role: 'killer', group: 'k42' },
  { id: 'Addon_K24Power_14', name: 'Licker Tongue', role: 'killer', group: 'k24' },
  { id: 'Addon_K24Power_2', name: 'Brian\u2019s Intestine', role: 'killer', group: 'k24' },
  { id: 'ADDON_LFChainsaw_ShopLubricant', name: 'Shop Lubricant', role: 'killer', group: 'lfchainsaw' },
  { id: 'Addon_Stalker_MemorialFlower', name: 'Memorial Flower', role: 'killer', group: 'stalker' },
  { id: 'Addon_Stalker_TackyEarrings', name: 'Tacky Earrings', role: 'killer', group: 'stalker' },
  { id: 'Addon_Toolbox_001', name: 'Scraps', role: 'survivor', group: 'toolbox' },
  { id: 'Addon_Toolbox_006', name: 'Protective Gloves', role: 'survivor', group: 'toolbox' },
  { id: 'Addon_Key_005', name: 'Blood Amber', role: 'survivor', group: 'key' },
  { id: 'Addon_Key_WeddingRing', name: 'Unique Wedding Ring', role: 'survivor', group: 'key' },
  ...
  { id: 'Addon_Bell_005', name: '"Swift Hunt" - Mud', role: 'killer', group: 'bell' },
  { id: 'ADDON_Bell_SwiftMud', name: '"Swift Hunt" - White', role: 'killer', group: 'bell' },
  { id: 'Addon_Bell_007', name: '"The Beast" - Soot', role: 'killer', group: 'bell', file: 'iconAddon_sootTheBeast.png' },
  { id: 'ADDON_Bell_AllseeingWhite', name: '"The Serpent" - Soot', role: 'killer', group: 'bell' },
  { id: 'Addon_DreamInducer_ZBlock', name: '"Z" Block', role: 'killer', group: 'dreaminducer' },
  { id: 'Addon_K33_20', name: 'Acidic Blood', role: 'killer', group: 'k33', file: 'iconAddon_acidicBlood.png' },
  { id: 'Addon_K44_07', name: 'Aurora\'s Telereceptor', role: 'killer', group: 'k44' },
  ...
  { id: 'Addon_K42_02', name: 'Bead Maze', role: 'killer', group: 'k42' },
  ...
  { id: 'Addon_GasBomb_14', name: 'Bottle of Chloroform', role: 'killer', group: 'gasbomb' },
  { id: 'Addon_K39_05', name: 'Broken Chain', role: 'killer', group: 'k39', file: 'T_UI_iconAddon_brokenChain.png' },
  ...
  { id: 'ADDON_Bell_CoxcombedClapper', name: 'Coxcombed Clapper', role: 'killer', group: 'bell' },
  { id: 'Addon_K44_19', name: 'Crown of the Destroyer', role: 'killer', group: 'k44' },
  { id: 'Addon_K41_07', name: 'Crumpled Sheet Music', role: 'killer', group: 'k41' },
  { id: 'Addon_Chainsaw_001', name: 'Dad\'s Boots', role: 'killer', group: 'chainsaw', file: 'iconAddon_dadsBoots.png' },
  { id: 'Addon_Hatchet_DeerskinGloves', name: 'Deerskin Gloves', role: 'killer', group: 'hatchet' },
  { id: 'Addon_K24Power_18', name: 'Depleted Ink Ribbon', role: 'killer', group: 'k24', file: 'iconAddon_depletedInkRibbon.png' },
  { id: 'Addon_K43_18', name: 'Deputy\'s Badge', role: 'killer', group: 'k43', file: 'T_UI_iconAddon_DeputysBadge.png' },
  { id: 'Addon_Plague_DevoteesAmulet', name: 'Devotee\'s Amulet', role: 'killer', group: 'plague' },
  { id: 'Addon_K43_19', name: 'Dirty Money', role: 'killer', group: 'k43' },
  { id: 'Addon_K33_05', name: 'Drinking Bird', role: 'killer', group: 'k33', file: 'iconAddon_drinkingBird.png' },
  { id: 'Addon_Ghost_DriversLicense', name: 'Driver\'s License', role: 'killer', group: 'ghost' },
  { id: 'Addon_Ghost_DropLegKnifeSheath', name: 'Drop-Leg Knife Sheath', role: 'killer', group: 'ghost' },
  { id: 'Addon_K29_14', name: 'Egg (Gold)', role: 'killer', group: 'k29' },
  { id: 'Addon_Demogorgon_ElevensSoda', name: 'Eleven\'s Soda', role: 'killer', group: 'qatarkiller', file: 'iconAddon_elevensSoda.png' },
  { id: 'Addon_GasBomb_17', name: 'Ether 15 vol%', role: 'killer', group: 'gasbomb', file: 'iconAddon_ether15.png' },
  { id: 'Addon_K44_17', name: 'Eyes of Gerhardt', role: 'killer', group: 'k44' },
  { id: 'Addon_K26Power_06', name: 'Festering Carrion', role: 'killer', group: 'k26' },
  ...
  { id: 'Addon_Blinker_007', name: 'Fragile Wheeze', role: 'killer', group: 'blinker' },
  { id: 'ADDON_Frenzy_FranksMixTape', name: 'Frank’s Mix Tape', role: 'killer', group: 'frenzy' },
  { id: 'Addon_K39_04', name: 'Fresh Coffee', role: 'killer', group: 'k39' },
  ...
  { id: 'Addon_K36_08', name: 'Glass Eye', role: 'killer', group: 'k36', file: 'iconAddon_GlassEye.png' },
  { id: 'Addon_Hatchet_GlowingConcoction', name: 'Glowing Concoction', role: 'killer', group: 'hatchet' },
  { id: 'Addon_Stalker_HairBow', name: 'Hair Bow', role: 'killer', group: 'stalker' },
  { id: 'Addon_K33_16', name: 'Harpoon Gun', role: 'killer', group: 'k33' },
  { id: 'ADDON_Lastbreath_HeavyPanting', name: 'Heavy Panting', role: 'killer', group: 'blinker', file: 'iconAddon_heavyPanting.png' },
  { id: 'Addon_K44_02', name: 'Heretic\'s Mark', role: 'killer', group: 'k44' },
  { id: 'Addon_Beartrap_001', name: 'Honing Stone', role: 'killer', group: 'beartrap' },
  { id: 'Addon_K43_12', name: 'Imprinted Aluminum', role: 'killer', group: 'k43' },
  ...
  { id: 'ADDON_LFChainsaw_IridescentFlesh', name: 'Iridescent Flesh', role: 'killer', group: 'lfchainsaw' },
  { id: 'Addon_Spark_IridescentGeneral', name: 'Iridescent King', role: 'killer', group: 'spark' },
  ...
  { id: 'Addon_Plague_IridescentSeal', name: 'Iridescent Seal', role: 'killer', group: 'plague' },
  { id: 'Addon_K30_13', name: 'Ironworker’s Tongs', role: 'killer', group: 'k30' },
  { id: 'Addon_Stalker_Jewelry', name: 'Jewelry', role: 'killer', group: 'stalker' },
  { id: 'Addon_K39_01', name: 'Kaneki\'s Wallet', role: 'killer', group: 'k39', file: 'T_UI_iconAddon_KanekisWallet.png' },
  { id: 'Addon_PhaseWalker_KatanaTsuba', name: 'Katana Tsuba', role: 'killer', group: 'phasewalker', file: 'iconAddon_katanaTsuba.png' },
  { id: 'Addon_K32_03', name: 'Kid’s Ball Glove', role: 'killer', group: 'k32' },
  { id: 'Addon_K37_11', name: 'Killer Doll', role: 'killer', group: 'k37', file: 'iconAddon_KillerDoll.png' },
  ...
  { id: 'Addon_K43_03', name: 'Knitting Needle', role: 'killer', group: 'k43' },
  { id: 'Addon_K44_01', name: 'Koenrad’s Gauntlet', role: 'killer', group: 'k44' },
  { id: 'Addon_K33_01', name: 'Lambert’s Star Map', role: 'killer', group: 'k33' },
  { id: 'Addon_K36_05', name: 'Lantern of Revealing', role: 'killer', group: 'k36', file: 'iconAddon_LanternOfRevealing.png' },
  { id: 'Addon_K37_18', name: 'Lapis Lazuli', role: 'killer', group: 'k37', file: 'iconAddon_LapisLazuli.png' },
  { id: 'Addon_K29_06', name: 'Leather Gloves', role: 'killer', group: 'k29', file: 'iconAddon_leatherGloves.png' },
  { id: 'Addon_Kanobo_LionFang', name: 'Lion Fang', role: 'killer', group: 'kanobo', file: 'iconAddon_lionFang.png' },
  { id: 'Addon_K31_13', name: 'Loose Screw', role: 'killer', group: 'k31' },
  { id: 'Addon_K37_05', name: 'Magical Ticket', role: 'killer', group: 'k37', file: 'iconAddon_MagicalTicket.png' },
  { id: 'Addon_K24Power_5', name: 'Marvin’s Blood', role: 'killer', group: 'k24' },
  { id: 'Addon_K24Power_7', name: 'Mikhail’s Eye', role: 'killer', group: 'k24' },
  { id: 'Addon_K43_11', name: 'Mirror Shards', role: 'killer', group: 'k43', file: 'T_UI_iconAddon_MirrorShards.png' },
  { id: 'Addon_K43_17', name: 'Missing Corkscrew', role: 'killer', group: 'k43' },
  { id: 'Addon_PhaseWalker_BloodyHairBrooch', name: 'Mother\'s Glasses', role: 'killer', group: 'phasewalker' },
  { id: 'Addon_K24Power_15', name: 'NE-α Parasite', role: 'killer', group: 'k24', file: 'iconAddon_neaParasite.png' },
  { id: 'Addon_K44_09', name: 'Order of Inquisition', role: 'killer', group: 'k44' },
  { id: 'Addon_K42_01', name: 'Orderly ID', role: 'killer', group: 'k42' },
  ...
  { id: 'Addon_K36_14', name: 'Pearl of Power', role: 'killer', group: 'k36', file: 'iconAddon_PearlOfPower.png' },
  ...
  { id: 'Addon_Blinker_003', name: 'Pocket Watch', role: 'killer', group: 'blinker', file: 'iconAddon_pocketWatch.png' },
  { id: 'Addon_Spark_PolishedElectrode', name: 'Polished Electrode', role: 'killer', group: 'spark' },
  { id: 'Addon_K44_04', name: 'Prayer Kneeler', role: 'killer', group: 'k44' },
  { id: 'Addon_DreamInducer_PrototypeClaws', name: 'Prototype Claws', role: 'killer', group: 'dreaminducer' },
  { id: 'Addon_K29_04', name: 'R.P.D. Shoulder Walkie', role: 'killer', group: 'k29', file: 'iconAddon_RPDShoulderWalkie.png' },
  { id: 'Addon_K39_17', name: 'Red-Headed Centipede', role: 'killer', group: 'k39' },
  ...
  { id: 'Addon_TheOnryo_10', name: 'Rickety Pinwheel', role: 'killer', group: 'k27', file: 'iconAddon_RicketyPinwheel.png' },
  { id: 'Addon_K36_09', name: 'Ring of Spell Storing', role: 'killer', group: 'k36', file: 'iconAddon_RingOfSpellStoring.png' },
  { id: 'Addon_PhaseWalker_RustyFlute', name: 'Rusty Flute', role: 'killer', group: 'phasewalker' },
  { id: 'Addon_K43_10', name: 'Sauna Rock', role: 'killer', group: 'k43' },
  { id: 'Addon_K44_14', name: 'Searcher\'s Skull', role: 'killer', group: 'k44' },
  { id: 'Addon_K33_18', name: 'Self-Destruct Bolt', role: 'killer', group: 'k33' },
  { id: 'Addon_K24Power_19', name: 'Shattered S.T.A.R.S. Badge', role: 'killer', group: 'k24' },
  { id: 'Addon_K43_05', name: 'Sleeping Bag', role: 'killer', group: 'k43', file: 'T_UI_iconAddon_SleepingBag.png' },
  { id: 'ADDON_Frenzy_SmileyFacePin', name: 'Smiley Face Pin', role: 'killer', group: 'frenzy' },
  { id: 'Addon_K32_15', name: 'Spent Oxygen Tank', role: 'killer', group: 'k32' },
  ...
  { id: 'Addon_Demogorgon_StickyLining', name: 'Sticky Lining', role: 'killer', group: 'qatarkiller', file: 'iconAddon_stickyLining.png' },
  { id: 'Addon_K41_01', name: 'Sticky Lozenge', role: 'killer', group: 'k41' },
  { id: 'Addon_GasBomb_08', name: 'Sticky Soda Bottle', role: 'killer', group: 'gasbomb' },
  { id: 'ADDON_Frenzy_NastyBlade', name: 'Stylish Sunglasses', role: 'killer', group: 'frenzy', file: 'iconAddon_nastyBlade.png' },
  { id: 'Addon_K37_12', name: 'Sunglasses', role: 'killer', group: 'k37', file: 'iconAddon_Sunglasses.png' },
  { id: 'Addon_GasBomb_19', name: 'Tattoo\'s Middle Finger', role: 'killer', group: 'gasbomb', file: 'iconAddon_tattoosMiddleFinger.png' },
  { id: 'ADDON_LFChainsaw_BeastsMarks', name: 'The Beast\'s Marks', role: 'killer', group: 'lfchainsaw', file: 'iconAddon_theBeastsMark.png' },
  { id: 'Addon_K26Power_03', name: 'Thick Tar', role: 'killer', group: 'k26' },
  { id: 'Addon_Blinker_005', name: 'Torn Bookmark', role: 'killer', group: 'blinker', file: 'iconAddon_tornBookmark.png' },
  { id: 'Addon_K30_14', name: 'Town Watch’s Torch', role: 'killer', group: 'k30' },
  { id: 'Addon_K43_07', name: 'Toxic Waste', role: 'killer', group: 'k43' },
  ...
  { id: 'Addon_K31_17', name: 'Ultrasonic Speaker', role: 'killer', group: 'k31' },
  { id: 'Addon_K29_03', name: 'Unicorn Medallion', role: 'killer', group: 'k29', file: 'iconAddon_unicornMedallion.png' },
  { id: 'Addon_K35_10', name: 'Vanishing Box', role: 'killer', group: 'k35' },
  { id: 'Addon_K35_09', name: 'Victim’s Map', role: 'killer', group: 'k35' },
  { id: 'Addon_K37_16', name: 'Warg\'s Fang', role: 'killer', group: 'k37', file: 'iconAddon_WargsFang.png' },
  ...
  { id: 'Addon_Blinker_002', name: 'White Nit Comb', role: 'killer', group: 'blinker', file: 'iconAddon_whiteNitComb.png' },
  ...
  { id: 'Addon_Hatchet_YewSeedBrew', name: 'Wooden Fox', role: 'killer', group: 'hatchet' },
  { id: 'Addon_Blinker_011', name: 'Wooden Horse', role: 'killer', group: 'blinker', file: 'iconAddon_woodenHorse.png' },
  { id: 'Addon_Kanobo_YamaokaSashimono', name: 'Yamaoka Sashimono', role: 'killer', group: 'kanobo', file: 'iconAddon_yamaokaSashimono.png' },
  { id: 'Addon_Hatchet_BerusToxin', name: 'Yellowed Cloth', role: 'killer', group: 'hatchet' },
  { id: 'Addon_TheOnryo_09', name: 'Yoichi\'s Fishing Net', role: 'killer', group: 'k27', file: 'iconAddon_YoichisFishingNet.png' },
  ...
  { id: 'Addon_Key_008', name: 'Braided Bauble', role: 'survivor', group: 'key' },
  ...
  { id: 'Addon_Key_001', name: 'Friendship Charm', role: 'survivor', group: 'key' },
  ...
  { id: 'Addon_Toolbox_004', name: 'Grip Wrench', role: 'survivor', group: 'toolbox', file: 'iconAddon_gripWrench.png' },
  ...
  { id: 'ADDON_medkit_needleandthread', name: 'Needle & Thread', role: 'survivor', group: 'medkit', file: 'iconAddon_needAndThread.png' },
  { id: 'ADDON_flashlight_oddbulb', name: 'Odd Bulb', role: 'survivor', group: 'flashlight', file: 'iconAddon_oddBulb.png' },
  { id: 'Addon_FogVial_SlowRelease', name: 'Oily Sap', role: 'survivor', group: 'fogvial', file: 'T_UI_iconAddon_oilySap.png' },
  ...
  { id: 'Addon_FogVial_LargeVial', name: 'Reactive Compound', role: 'survivor', group: 'fogvial', file: 'T_UI_iconAddon_reactiveCompound.png' },
