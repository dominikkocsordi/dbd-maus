...
import { loadoutEntry, loadoutName } from './loadout.js?v=57';
import { saveLoadoutCatalog } from './loadout-catalog.js?v=57';
import { perkName } from './perks.js?v=57';
import { gameModeLabel, labelFor } from './data.js?v=57';
import { escapeHtml, fmtDate, fmtNumber, toast } from './utils.js?v=57';
import { attachBuilds, markDuplicates, parseMatchHistory } from './tracker-import.js?v=57';
...
async function mountBookmarklet() {
  ...
  try {
    const res = await fetch('assets/js/tracker-bookmarklet.js?v=57');
