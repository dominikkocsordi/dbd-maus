...
import { saveLoadoutCatalog } from './loadout-catalog.js?v=70';
import { perkName } from './perks.js?v=70';
import { facedKillersLabel, gameModeLabel, labelFor } from './data.js?v=70';
import { escapeHtml, fmtDate, fmtNumber, toast } from './utils.js?v=70';
import { attachBuilds, markDuplicates, parseMatchHistory } from './tracker-import.js?v=70';
...
async function mountBookmarklet() {
  ...
  try {
    const res = await fetch('assets/js/tracker-bookmarklet.js?v=70');
