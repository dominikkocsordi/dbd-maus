...
import { loadoutEntry, loadoutName } from './loadout.js?v=69';
import { saveLoadoutCatalog } from './loadout-catalog.js?v=69';
import { perkName } from './perks.js?v=69';
import { facedKillersLabel, gameModeLabel, labelFor } from './data.js?v=69';
import { escapeHtml, fmtDate, fmtNumber, toast } from './utils.js?v=69';
import { attachBuilds, markDuplicates, parseMatchHistory } from './tracker-import.js?v=69';
...
async function mountBookmarklet() {
  ...
  try {
    const res = await fetch('assets/js/tracker-bookmarklet.js?v=69');
